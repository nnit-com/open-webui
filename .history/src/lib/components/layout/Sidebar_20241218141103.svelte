...
>
	...
	>
		...
		<div class="px-0.5 flex justify-between space-x-1 text-gray-800 dark:text-gray-200">
			<a
		...
		<div class="px-1.5 flex justify-center text-gray-800 dark:text-gray-200">
			...
			>
				...
				<div class="flex self-center">
					<div class=" self-center font-medium text-sm font-primary">{$i18n.t('Mask')}</div>
				</div>
			</a>
		</div>
